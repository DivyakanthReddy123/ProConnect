...
export class NavbarComponent implements OnInit {
  ...
  makeRedirectUrl(userDetails: UserDetails): string {
    ...
    else if (this.hasRole('RECRUITER', userDetails)) redirectUrl = '/recruiter/dashboard';
  ...
  isRecruiter(): boolean {
    return this.hasRole('RECRUITER', this.userDetails);
  }
  ...
  submitSearch(): void {
    ...
    this.router.navigate(['/network'], { queryParams: { q: query } });
  }
