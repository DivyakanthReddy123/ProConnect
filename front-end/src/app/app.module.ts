...
import { RecruiterPostJobComponent } from './recruiter/recruiter-post-job/recruiter-post-job.component';
import { RecruiterMyJobsComponent } from './recruiter/recruiter-my-jobs/recruiter-my-jobs.component';
...
const appRoutes: Routes = [
  ...
  { path: 'recruiter/post-job', component: RecruiterPostJobComponent },
  { path: 'recruiter/jobs', component: RecruiterMyJobsComponent },
  { path: 'recruiter/jobs/:jobId/applicants', component: RecruiterApplicantsComponent },
