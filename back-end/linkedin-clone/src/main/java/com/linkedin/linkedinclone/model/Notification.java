...
public class Notification {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = {"usersApplied","recommendedTo","userMadeBy"},allowSetters = true)
    @EqualsAndHashCode.Exclude
    @ToString.Exclude
    private Job new_job = null;
    ...
    public Notification(@NonNull NotificationType type, User user, Job new_job) {
        this.type = type;
        this.user = user;
